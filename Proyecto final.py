# el control de errores hay que hacerlo con bloques try catch
print("Proyecto final Curso IBM Bejob de programación en Python")
""" 
Enunciado: Escribe un programa en Python utilizando Programación Orientada a Objetos que gestione una lista de tareas pendientes. 
